...
ace.define("ace/mode/anchor_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules"], function(require, exports, module) {
"use strict";
...
var JavaHighlightRules = function() {
    ...
    "var|" +
    "moves_as|invariant|requires|ensures|yield|modifies|yields_as|noABA|old|array|isLocal|$result|bool|ghost|isRead|" +
    "cas|commit|holds|isLocal|isShared|axiom|acquire|release|synchronized|cas|forall|exists|" +
    "decreases|assume|nocheck|tid|Set|Seq|Multiset|Map|nextSpecStep"
    );

    var buildinConstants = ("null|Infinity|NaN|undefined|B|N|E|L|R|threadlocal|readonly|guarded_by|write_guarded_by|immutable|whenever|INT_MAX|INT_MIN");
...
ace.define("ace/mode/anchor",["require","exports","module","ace/lib/oop","ace/mode/javascript","ace/mode/anchor_highlight_rules","ace/mode/folding/java"], function(require, exports, module) {
    "use strict";
    ...
    exports.Mode = Mode;
                    ...
                    ace.require(["ace/mode/anchor"], function(m) {
